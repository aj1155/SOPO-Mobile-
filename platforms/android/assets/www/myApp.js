...
app.controller('PhotoController', function($scope,ServerService, PhotoService,$rootScope) {
    function onSuccess(imageURL) {
        var userId = 1;
        ServerService.imageUpload(userId, imageURL, function(result) {


              $("#image").attr("src","http://192.168.0.20:3000/images/"+$rootScope.user.name+".jpg" );
